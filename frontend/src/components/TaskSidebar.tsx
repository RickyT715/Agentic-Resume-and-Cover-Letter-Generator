...
import { Plus, FileText, CheckCircle, XCircle, Loader2, Trash2, Ban, Clock } from 'lucide-react';
...
export function TaskSidebar() {
  const { tasks, activeTaskId, setActiveTask, addTask, removeTask, updateTask, addToast } = useTaskStore();
  ...
  const getTaskLabel = (task: Task) => {
    if (task.company_name && task.position_name) return `${task.company_name} - ${task.position_name}`;
  ...
  return (
    <div className="w-72 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <h1 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Resume Generator</h1>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <span className="font-medium text-gray-700 dark:text-gray-200 truncate">{getTaskLabel(task)}</span>
