...
class TestGeminiClient:
    ...
    def test_get_client_raises_without_api_key(self):
        ...
        with (
            patch("services.gemini_client.get_settings_manager", return_value=mock_sm),
...
class TestClaudeClient:
    ...
    def test_get_client_raises_without_api_key(self):
        ...
        mock_sm.get.return_value = ""
        with (
            patch("services.claude_client.get_settings_manager", return_value=mock_sm),
...
class TestOpenAICompatClient:
    ...
    def test_model_default(self):
        ...
        mock_sm.get.return_value = None
        with (
            patch("services.openai_compat_client.get_settings_manager", return_value=mock_sm),
