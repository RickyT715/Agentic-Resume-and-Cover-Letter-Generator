...
async def evaluate_resume(
    ...
    return {
        ...
        "ats_breakdown": {
            "keyword_similarity": ats_result.keyword_similarity,
            "semantic_similarity": ats_result.semantic_similarity,
            "skill_coverage": ats_result.skill_coverage,
            "fuzzy_match": ats_result.fuzzy_match,
            "resume_quality": ats_result.resume_quality,
            "section_bonus": ats_result.section_bonus,
            "action_verbs_score": ats_result.action_verbs_score,
            "quantified_score": ats_result.quantified_score,
