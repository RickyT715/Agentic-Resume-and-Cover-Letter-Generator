...
class GeminiClient(AIClientBase):
    ...
    def _save_gemini_response(self, task_id: str, task_number: int, response_type: str,
                              prompt: str, response: str, grounding_metadata: dict = None) -> Path:
...
Generation Parameters:
  ...
  - Search Grounding: disabled"""
    ...
    def _extract_grounding_metadata(self, response) -> Optional[dict]:
    ...
    async def generate(
        ...
        logger.info(f"Sending request to Gemini API (model={self.model}, thinking_level={effective_thinking}, search={effective_search})")
    ...
    async def generate_resume(self, prompt: str, task_id: str = None,
                              task_number: int = None) -> str:
    ...
    async def generate_cover_letter(self, prompt: str, task_id: str = None,
                                     task_number: int = None) -> str:
    ...
    async def generate_question_answer(self, prompt: str, task_id: str = None,
                                        task_number: int = None,
    ...
    async def generate_resume_with_error_feedback(
        self, prompt: str, error_log: str, previous_latex: str,
        task_id: str = None, task_number: int = None, attempt: int = 1
    ) -> str:
