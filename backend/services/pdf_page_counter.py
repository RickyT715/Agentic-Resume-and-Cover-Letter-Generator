...
def _get_page_count_fitz(pdf_path: Path) -> Optional[int]:
...
def _get_page_count_pdfinfo(pdf_path: Path) -> Optional[int]:
...
def _get_page_count_pypdf2(pdf_path: Path) -> Optional[int]:
